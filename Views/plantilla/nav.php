      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <!-- <span class="mr-2 d-none d-lg-inline text-gray-600 small">Sistema ALMACENLTE 1.0</span> -->
                <img src="<?= PLANTILLA?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="img-profile rounded-circle" style="height: 50px;width: 50px;margin-top: -15px;opacity: .5">
              </a>
